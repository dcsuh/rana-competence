...
output_c1 <- as.data.frame(lsoda(xstart_n,times,rm1,params_c)) # tells computer to solve (integrate) equations
...
output_a1 <- as.data.frame(lsoda(xstart_n,times,rm1,params_a)) # tells computer to solve (integrate) equations
...
output_h1 <- as.data.frame(lsoda(xstart_n,times,rm1,params_h)) # tells computer to solve (integrate) equations
...
output_x1 <- as.data.frame(lsoda(xstart_n,times,rm1,params_x)) # tells computer to solve (integrate) equations
