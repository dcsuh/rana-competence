...
figure_3 <- ggplot(data=lag_evenness,aes(x=lag_J, y=lag_cc)) +
  ...
  labs(x="Evenness", y = "Community Competence", size = "Host\nAbundance") +
...
figure_3 
ggsave("fig_3.png",plot=figure_3 + proj_theme,width = outwidth[1], height = outwidth[1]/golden,device="png",path=here("figures"))
