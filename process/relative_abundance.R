...
data %<>% mutate(., total = AB9 + AB20 + AB21 + AB24 + 
                   AB26 + AB28 + AB29 + AB34 + AB35 + AB38 + AB39 + AB41 + AB42) #sum is everything except for ABAmb and ABSal
data %<>% mutate(.,RA4 = AB4/total,
                   RA9 = AB9/total,
                   RA20 = AB20/total,
                   RA21 = AB21/total,
                   RA24 = AB24/total,
