...
pckg_names <- c("tidyverse", "magrittr", "here", "vegan", "patchwork", "ggnewscale", "ape", "rotl", "picante", "metacom", "ggrepel")
...
proj_theme <- theme_set(theme_bw(base_size = 18)) #theme set will set plot theme without having to specify within ggplot
